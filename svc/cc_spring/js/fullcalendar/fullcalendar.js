...
// Can be called with another class, or a plain object hash containing new members.
    ...
    var Popover = Class.extend({
        ...
        render: function() {
            ...
            this.el = $('<div class="fc-popover" tabindex="0"/>')
...
// NOTE: all the segs being passed around in here are foreground segs
    ...
    DayGrid.mixin({
        ...
        limitRow: function(row, levelLimit) {
            ...
            /* 모달팝업 버튼 title 추가 20180111 */
             var popOption = this.view.opt('eventLimitClick');
             if (popOption === 'popover') {
                $(".fc-more").attr("title", "팝업열림");
             }
             /* //모달팝업 버튼 title 추가 20180111 */
        },
        ...
        renderMoreLink: function(row, col, hiddenSegs) {
            var _this = this;
            var view = this.view;
            return $('<a href="#lnk" class="fc-more"/>')
        ...
        showSegPopover: function(row, col, moreLink, segs) {
            ...
            this.el.after("<div class='sch-calendar-dimed'></div>");
        },
        ...
        renderSegPopoverContent: function(row, col, segs) {
            ...
            var content = $(
                    ...
                    '</div>'+
                    '<a href="#lnk" title="팝업닫기" class="fc-close ' +
                    ...
                    $.each(this.split(','), function(j, buttonName) {
                        ...
                        if (buttonName == 'title') {
                            ...
                            if (buttonClick) {
                                ...
                                /* 20180111 이전, 다음 title 추가 */
                                if(buttonName == "prev") {
                                    button.attr("title", "이전 달로 이동");
                                }else if(buttonName == "next") {
                                    button.attr("title", "다음 달로 이동");
                                }
